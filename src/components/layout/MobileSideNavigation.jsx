    ...
    >
      ...
      >
        ...
        <button
          type="button"
          onClick={onClose}
          className="absolute top-4 right-4 z-10 cursor-pointer rounded-full p-1.5 text-slate-300 transition-colors duration-200 hover:text-white"
          aria-label="모바일 메뉴 닫기"
          tabIndex={tabIndex}
        >
